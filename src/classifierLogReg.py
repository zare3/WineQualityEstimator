...
AVERAGE CORRECCT CLASSIFICATION ON ALL RUNS:  0.963793103448
AVERAGE MAD ON ALL RUNS:  0.462382445141
...
for idx in range(num_runs):
    ...
    clfLogReg.fit (trainds,trainlabels)

    print "Predicting"

    outputs = clfLogReg.predict (testds)
    print "Testing"
