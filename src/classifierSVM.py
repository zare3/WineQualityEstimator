...
'''
AVERAGE CORRECCT CLASSIFICATION ON ALL RUNS:  0.948275862069
AVERAGE MAD ON ALL RUNS:  0.47789968652
...
for idx in range(num_runs):
    ...
    clfSVM =  svm.SVC(kernel = 'rbf', probability = True, max_iter = 1000)

    clfSVM.fit (trainds,trainlabels)

    print "Predicting"

    outputs = clfSVM.predict (testds)
    print "Testing"
