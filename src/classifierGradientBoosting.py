...
'''
AVERAGE CORRECCT CLASSIFICATION ON ALL RUNS:  0.958150470219
AVERAGE MAD ON ALL RUNS:  0.358463949843
'''
num_folds = 5
num_runs = 20
...
for idx in range(num_runs):
    ...
    clfGrd.fit (trainds,trainlabels)

    print "Predicting"

    outputs = clfGrd.predict (testds)
    print "Testing"
